...
public class AnimationReader {
   ...
   * </p>
   *
   * @param <Models> The main model interface type describing animations
   * @param readable The source of data for the animation
   * @param builder  A builder for helping to construct a new animation
   * @return
   */
  public static <Models> Models parseFile(Readable readable, AnimationBuilder<Models> builder) {
  ...
  private static <Models> void readCanvas(Scanner s, AnimationBuilder<Models> builder) {
    int[] vals = new int[4];
  ...
  private static <Models> void readShape(Scanner s, AnimationBuilder<Models> builder) {
    String name;
    String type;
    if (s.hasNext()) {
      name = s.next();
  ...
  private static <Models> void readMotion(Scanner s, AnimationBuilder<Models> builder) {
